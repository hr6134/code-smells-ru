...
В идеальном случае условие можно просто упростить Для этого пользуемся правилами булевой алгебры 
...
1. Уменьшаем длину цикла. Идеальный цикл содержит не больше 2х строчек кода.
